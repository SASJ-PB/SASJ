...
public class AtualizacaoAudienciaSucesso {
  ...
  public void testAtualizarAudienciaComSucesso() throws Exception {
    ...
    driver.findElement(By.xpath("//mat-tab-body[@id='mat-tab-content-1-0']/div/app-agendamento-tabela/div[2]/table/tbody/tr[7]/td[4]/button")).click();
