...
public class CadastroUsuarioCampoMatriculaInvalido extends TestCase {
	...
	@Test
	public void testCadastrarUsuarioComCampoMatriculaInvalido() throws Exception {
		...
		driver.findElement(By.id("campoMatricula")).sendKeys("js-44");
		...
		try {
		    assertEquals("A matrícula informada é inválida. Deve seguir o padrão: MM-123 ou MM-1234", 
