...
public class CadastroConciliacaoCampoNomeDaParteVazio extends TestCase {
  ...
  @Test
  public void testTentarCadastrarConciliacaoComCampoNomeDaParteVazio() throws Exception {
        ...
        driver.findElement(By.id("campo-hora")).sendKeys("14:20");
        driver.findElement(By.id("campo-numero-processo")).sendKeys("0502181-08.2016.4.05.8203T");
