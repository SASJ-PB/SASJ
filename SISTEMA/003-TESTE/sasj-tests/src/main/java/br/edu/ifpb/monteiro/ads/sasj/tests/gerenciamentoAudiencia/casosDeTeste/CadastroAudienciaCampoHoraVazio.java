...
public class CadastroAudienciaCampoHoraVazio extends TestCase{
  ...
  @Test
  public void testTentarCadastrarAudienciaComCampoHoraVazio() throws Exception {
        ...
        driver.findElement(By.id("campo-data")).sendKeys("10/10/2015");
        driver.findElement(By.id("campo-hora")).sendKeys("");
        driver.findElement(By.id("campo-numero-processo")).sendKeys("333.333.3333-33333.3333.33333");
        driver.findElement(By.id("campo-nome-parte")).sendKeys("John");
        driver.findElement(By.id("campo-tipo-sessao")).sendKeys("Audiência");
        driver.findElement(By.id("campo-oitivas")).clear();
        driver.findElement(By.id("campo-oitivas")).sendKeys("9");
