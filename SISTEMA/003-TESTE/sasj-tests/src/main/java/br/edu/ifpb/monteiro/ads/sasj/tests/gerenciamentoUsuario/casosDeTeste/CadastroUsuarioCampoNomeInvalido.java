...
public class CadastroUsuarioCampoNomeInvalido extends TestCase {
	...
	@Test
	public void testCadastrarUsuarioComCampoNomeInvalido() throws Exception {
		...
		driver.findElement(By.id("campoNome")).sendKeys("Wagner");
		driver.findElement(By.id("campoMatricula")).sendKeys("ww-5555");
		driver.findElement(By.id("campoCargo")).sendKeys("Téc.");
		driver.findElement(By.id("campoEmail")).sendKeys("wagner@mail");
		driver.findElement(By.id("campoTipoUsuario")).sendKeys("Padrão");

		driver.findElement(By.id("botaoCadastrarUsuario")).click();
		try {
		    assertEquals("O nome informado é inválido. Deve seguir o padrão: Nome Sobrenome", 
