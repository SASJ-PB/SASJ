...
public class AutenticacaoSucesso extends TestCase{
  ...
  public void testTentarAutenticarComSucesso() throws Exception {
        ...
        try {
            assertEquals("Bem-vindo(a) João Silva", driver.findElement(By.xpath("//div[@id='div-label-bem-vindo']/span")).getText());
        } catch (Error e) {
