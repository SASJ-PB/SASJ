...
public class CadastroUsuarioCampoCargoVazio extends TestCase {
	...
	@Test
	public void testCadastrarUsuarioComCampoCargoVazio() throws Exception {
		...
		driver.findElement(By.id("campoNome")).sendKeys("André Luís");
		driver.findElement(By.id("campoMatricula")).sendKeys("al-2222");
		driver.findElement(By.id("campoEmail")).sendKeys("andre@email");
