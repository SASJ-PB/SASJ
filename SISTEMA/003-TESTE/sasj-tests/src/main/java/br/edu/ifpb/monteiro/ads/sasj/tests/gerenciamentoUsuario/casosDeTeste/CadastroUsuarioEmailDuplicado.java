...
public class CadastroUsuarioEmailDuplicado extends TestCase {
	...
	@Test
	public void testCadastrarUsuarioComEmailDuplicado() throws Exception {
		...
		driver.findElement(By.id("campoNome")).sendKeys("Michael Ramos");
		driver.findElement(By.id("campoMatricula")).sendKeys("mr-7777");
		driver.findElement(By.id("campoCargo")).sendKeys("Téc.");
		driver.findElement(By.id("campoEmail")).sendKeys("michael@mail");
		...
		driver.findElement(By.id("campoNome")).sendKeys("Nilton Barbosa");
		driver.findElement(By.id("campoMatricula")).sendKeys("nb-8888");
		driver.findElement(By.id("campoCargo")).sendKeys("Téc.");
		driver.findElement(By.id("campoEmail")).sendKeys("michael@mail");
