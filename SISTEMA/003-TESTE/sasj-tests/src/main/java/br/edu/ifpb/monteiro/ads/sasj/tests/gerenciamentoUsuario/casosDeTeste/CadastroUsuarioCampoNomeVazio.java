...
public class CadastroUsuarioCampoNomeVazio extends TestCase {
	...
	public void testCadastrarUsuarioComCampoNomeVazio() throws Exception {
		...
		driver.findElement(By.id("campoMatricula")).sendKeys("nn-6666");
		driver.findElement(By.id("campoCargo")).sendKeys("Téc.");
		driver.findElement(By.id("campoEmail")).sendKeys("none@mail");
