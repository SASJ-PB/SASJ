...
public class CadastroConciliacaoCampoOitivasVazio extends TestCase{
  ...
  @Test
  public void testTentarCadastrarConciliacaoComCampoOitivasVazio() throws Exception {
        ...
        driver.findElement(By.id("campo-data")).sendKeys("16/03/2017");
        driver.findElement(By.id("campo-hora")).sendKeys("14:40");
        driver.findElement(By.id("campo-numero-processo")).sendKeys("0500008-74.2017.4.05.8203S");
        driver.findElement(By.id("campo-nome-parte")).sendKeys("VANESSA FERNANDA DA SIVA");
