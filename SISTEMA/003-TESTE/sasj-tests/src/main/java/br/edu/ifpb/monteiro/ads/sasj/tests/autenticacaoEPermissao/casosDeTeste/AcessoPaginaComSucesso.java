...
public class AcessoPaginaComSucesso extends TestCase{
  ...
  @Test
  public void testTentarAcessarPaginaComSucesso() throws Exception {
    ...
    try {
    	assertFalse(isElementPresent(By.xpath("//button[id='botao-novo-usuario']")));
	}catch (Error e) {
